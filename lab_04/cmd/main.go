...
import (
	"fmt"
	"github.com/AskaryanKarine/BMSTU-CC/lab_04/internal/fs"
	"github.com/AskaryanKarine/BMSTU-CC/lab_04/internal/lexer"
	"github.com/AskaryanKarine/BMSTU-CC/lab_04/internal/parser"
	"os"
	"strings"
)
...
func main() {
	...
	if ok {
		...
		fmt.Println("Обратная польская нотация:", strings.Join(rpnTokens, " "))
